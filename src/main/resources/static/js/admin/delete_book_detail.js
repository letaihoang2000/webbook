$(document).ready(function() {
    console.log('=== delete_book_detail.js loaded ===');
    ...
    $(document).on('click', '.delete-book-btn', function() {
        ...
        const bookImage = $('#book_detail_image').attr('src');
        const bookAuthor = $('#book_detail_author').text().trim();
        const bookPrice = $('#book_detail_price').text().trim();
    ...
    function showSuccessMessage(message) {
        ...
        `;
        $('#content > .back-button').after(alertHtml);
